...
{
    m_world->setFoodPosition(std::make_pair(position.x, position.y));

    DisplayInd placeNewFood;
    placeNewFood.position.x = position.x;
    placeNewFood.position.y = position.y;
...
void Controller::addHeadSegment(Position position)
{
    ...
    placeNewHead.position.x = position.x;
    placeNewHead.position.y = position.y;
...
{
    if (std::make_pair(position.x,position.y) == m_world->getFoodPosition()) {
